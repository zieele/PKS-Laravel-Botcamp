...
<body>
    ...
    <?php 
        ...
        */
        ...
        $le = count($items);
        $output  = [];
        // array_push($output, array("id" => $items[0][0], "name" => $items[0][1], "price" => $items[0][2], "description" => $items[0][3], "source" => $items[0][4]));
        // array_push($output, array("id" => $items[1][0], "name" => $items[1][1], "price" => $items[1][2], "description" => $items[1][3], "source" => $items[1][4]));

        for ($m = 0; $m < $le; $m++) { 

            array_push($output, array("id" => $items[$m][0], "name" => $items[$m][1], "price" => $items[$m][2], "description" => $items[$m][3], "source" => $items[$m][4]));
