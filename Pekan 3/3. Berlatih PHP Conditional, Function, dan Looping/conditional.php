...
<html lang="en">
    ...
    <body>
        ...
        */
        ...
        echo "<br>";
        print_r(reverseString("Digital School"));
        echo "<br>";
        print_r(reverseString("We Are PKS Digital School Developers"));
        ...
        */
        ...
        print_r(palindrome("jambaban")); // false
